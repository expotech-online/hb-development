...
ALLOWED_HOSTS = ['www.ma-hb.com', 'ma-hb.com','https://www.ma-hb.com/']
...
ROOT_URLCONF = 'HBDevelopment.urls'
...
WSGI_APPLICATION = 'HBDevelopment.wsgi.application'
...
# STATIC_ROOT = os.path.join(BASE_DIR, 'static')
# STATICFILES_DIRS = [os.path.join(BASE_DIR, 'HBDevelopment/static')]
